...
interface MoverMemorizedElementEventDetails {
    memorizedElement: HTMLElement | undefined;
}
type MoverMemorizedElementEvent = CustomEvent<MoverMemorizedElementEventDetails | undefined>;
...
declare const Types_d_MoverMemorizedElementEventName: typeof MoverMemorizedElementEventName;
declare const Types_d_FocusableSelector: typeof FocusableSelector;
type Types_d_MoverMoveFocusEvent = MoverMoveFocusEvent;
type Types_d_MoverMemorizedElementEventDetails = MoverMemorizedElementEventDetails;
type Types_d_MoverMemorizedElementEvent = MoverMemorizedElementEvent;
...
declare namespace Types_d {
  export {
    ...
    Types_d_MoverMemorizedElementEventName as MoverMemorizedElementEventName,
    Types_d_FocusableSelector as FocusableSelector,
    Types_d_MoverMoveFocusEvent as MoverMoveFocusEvent,
    Types_d_MoverMemorizedElementEventDetails as MoverMemorizedElementEventDetails,
    Types_d_MoverMemorizedElementEvent as MoverMemorizedElementEvent,
...
export { Types_d as Types, createTabster, dispatchGroupperMoveFocusEvent, dispatchMoverMemorizedElementEvent, dispatchMoverMoveFocusEvent, disposeTabster, forceCleanup, getCrossOrigin, getDeloser, getGroupper, getInternal, getModalizer, getMover, getObservedElement, getOutline, getRestorer, getShadowDOMAPI, getTabster, getTabsterAttribute, isNoOp, makeNoOp, mergeTabsterProps, setTabsterAttribute };
