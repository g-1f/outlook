...
export declare const MoveFocusEventName = "tabster:movefocus";
...
export type MoverMoveFocusEvent = CustomEvent<{
    key: MoverKey;
} | undefined>;
export interface MoverMemorizedElementEventDetails {
    memorizedElement: HTMLElement | undefined;
}
export type MoverMemorizedElementEvent = CustomEvent<MoverMemorizedElementEventDetails | undefined>;
